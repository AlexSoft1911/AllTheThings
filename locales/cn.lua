...
for key, value in pairs({
	...
	[3076] = "沾满泥土的地图",	-- Dirt-stained Map
	[3189] = "进攻计划：试炼谷",	-- Attack Plan: Valley of Trials
	[3190] = "进攻计划：森金村",	-- Attack Plan: Sen'jin Village
	[3192] = "进攻计划：奥格瑞玛",	-- Attack Plan: Orgrimmar
	[3236] = "侏儒工具箱",	-- Gnomish Toolbox	--TODO: This was taken from wotlk Wowhead
	--TODO: [3237] = "Imprisoned Darkspear",	-- Imprisoned Darkspear
	[3238] = "老陈的空酒桶",	-- Chen's Empty Keg	--TODO: This was taken from wotlk Wowhead
	[3239] = "本尼迪克的箱子",	-- Benedict's Chest	--TODO: This was taken from wotlk Wowhead
	[3240] = "鞭尾龙的蛋",	-- Taillasher Eggs	--TODO: This was taken from wotlk Wowhead
	[3290] = "被偷走的补给袋",	-- Stolen Supply Sack
	...
	[10076] = "占卜之碗",	-- Scrying Bowl	--TODO: This was taken from wotlk Wowhead
	[11713] = "毒帽蘑菇",	-- Death Cap	--TODO: This was taken from wotlk Wowhead
	[11714] = "粗柄蘑菇",	-- Scaber Stalk	--TODO: This was taken from wotlk Wowhead
	[12666] = "暮光之书",	-- Twilight Tome	--TODO: This was taken from wotlk Wowhead
	[13360] = "黑暗深渊遗物",	-- Mathystra Relic	--TODO: This was taken from wotlk Wowhead
	...
	[16393] = "上古之火",	-- Ancient Flame	--TODO: This was taken from wotlk Wowhead
	[17182] = "传声盒827号",	-- Buzzbox 827	--TODO: This was taken from wotlk Wowhead
	[17183] = "传声盒411号",	-- Buzzbox 411	--TODO: This was taken from wotlk Wowhead
	[17184] = "传声盒323号",	-- Buzzbox 323	--TODO: This was taken from wotlk Wowhead
	[17188] = "亚米萨兰的衰落",	-- The Lay of Ameth'Aran	--TODO: This was taken from wotlk Wowhead
	[17189] = "亚米萨兰的毁灭",	-- The Fall of Ameth'Aran	--TODO: This was taken from wotlk Wowhead
	[17282] = "草药",	-- Plant Bundle
	[17783] = "古代雕像",	-- Ancient Statuette
	[19015] = "月神之泪",	-- Elune's Tear
	[19016] = "星尘覆盖的草丛",	-- Stardust Covered Bush
	[19021] = "生锈的箱子",	-- Rusty Chest	--TODO: This was taken from wotlk Wowhead
	[19022] = "旧箱子",	-- Worn Chest
	[19023] = "|cFFFFFFFF第7步:|r 第2351页",	-- |cFFFFFFFFStep 7:|r Page 2351
	[19024] = "隐蔽的神龛",	-- Hidden Shrine
	[19027] = "迈萨迪斯之书",	-- Tome of Mel'Thandris
	...
	[19901] = "禁锢法阵",	-- Circle of Imprisonment	--TODO: This was taken from wotlk Wowhead
	...
	[175165] = "银色清晨号的保险箱",	-- Silver Dawning's Lockbox	--TODO: This was taken from wotlk Wowhead
	[175166] = "迷雾之纱号的保险箱",	-- Mist Veil's Lockbox	--TODO: This was taken from wotlk Wowhead
	[175207] = "搁浅的海洋生物",	-- Beached Sea Creature	--TODO: This was taken from wotlk Wowhead
	[175226] = "搁浅的海洋生物",	-- Beached Sea Creature	--TODO: This was taken from wotlk Wowhead
	[175227] = "搁浅的海洋生物",	-- Beached Sea Creature	--TODO: This was taken from wotlk Wowhead
	[175230] = "搁浅的海洋生物",	-- Beached Sea Creature	--TODO: This was taken from wotlk Wowhead
	[175233] = "搁浅的海洋生物",	-- Beached Sea Creature	--TODO: This was taken from wotlk Wowhead
	...
	[176189] = "海龟骨头",	-- Skeletal Sea Turtle	--TODO: This was taken from wotlk Wowhead
	[176190] = "搁浅的海龟",	-- Beached Sea Turtle	--TODO: This was taken from wotlk Wowhead
	[176191] = "搁浅的海龟",	-- Beached Sea Turtle	--TODO: This was taken from wotlk Wowhead
	[176192] = "游荡者目录",	-- Catalogue of the Wayward	--TODO: This was taken from wotlk Wowhead
	[176196] = "搁浅的海龟",	-- Beached Sea Turtle
	[176197] = "搁浅的海龟",	-- Beached Sea Turtle	--TODO: This was taken from wotlk Wowhead
	[176198] = "搁浅的海龟",	-- Beached Sea Turtle	--TODO: This was taken from wotlk Wowhead
	...
	[176634] = "克罗尼亚的箱子",	-- Kerlonian's Chest	--TODO: This was taken from wotlk Wowhead
	...
	[180526] = "贝瑟克之锣",	-- Gong of Bethekk	--TODO: This was taken from wotlk Wowhead
	[180570] = "小桶",	-- Keg
	...
	[188164] = "卡斯卡拉补给品",	-- Kaskala Supplies
	...
	[192046] = "蚌背鱼群",	-- Musselback Sculpin School
	[192048] = "龙鳞天使鱼群",	-- Dragonfin Angelfish School
	[192049] = "利齿青鱼群",	-- Fangtooth Herring School
	[192050] = "冰河鲑鱼群",	-- Glacial Salmon School
	[192051] = "北风水母群",	-- Borean Man O' War School
	[192052] = "帝王鳐群",	-- Imperial Manta Ray School
	--TODO: [192053] = "Deep Sea Monsterbelly School",	-- Deep Sea Monsterbelly School
	--TODO: [192054] = "Moonglow Cuttlefish School",	-- Moonglow Cuttlefish School
	[192057] = "水母群",	-- Nettlefish School
	[192059] = "晶鳞鱼群",	-- Glassfin Minnow School
	...
	[375668] = "迷雾宝箱",	-- Misty Treasure Chest
	...
	[376175] = "满帆补给箱",	-- Fullsails Supply Chest
	--TODO: [376213] = "Mysterious Wand",	-- Mysterious Wand
	[376386] = "翻动过的泥土",	-- Disturbed Dirt
	[376426] = "魔缚宝箱",	-- Magic-Bound Chest
	--TODO: [376451] = "Bronze Stopwatch",	-- Bronze Stopwatch
	[376580] = "贾拉丁宝箱",	-- Djaradin Cache
	[376581] = "氏族宝箱",	-- Clan Chest
	[376582] = "海象人宝箱",	-- Tuskarr Chest
	[376587] = "探险队斥候的背包",	-- Expedition Scout's Pack
	--TODO: [376657] = "Ancient Monument",	-- Ancient Monument
	[376757] = "通缉：弗里基鲁斯",	-- WANTED: Frigellus
	...
	[380457] = "实验性腐朽坩埚",	-- Experimental Decay Cauldron
	...
	[380611] = "可疑之水的水壶",	-- Canteen of Suspicious Water
	[380612] = "手语对照表",	-- Sign Language Reference Sheet
	[380615] = "偷猎者的背包",	-- Poacher's Pack
	[380616] = "一小篮火水之粉",	-- Small Basket of Firewater Powder
	...
	--TODO: [380763] = "Ancient Dragonweave Loom",	-- Ancient Dragonweave Loom
